...
class Product {
    ...
    void tampil() {
        System.out.println("=================================");
        System.out.println("| PRODUCT NAME : " + this.nama);
        System.out.println("| PRODUCT PRICE : " + this.harga);
        System.out.println("| PRODUCT TYPE : " + this.jenis); 
        System.out.println("| PRODUCT STOCK : " + this.stok); 
    }
